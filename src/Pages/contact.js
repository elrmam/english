    ...
    return (
        <div className="container-fluid mb-5 " id='cources'>
            ...
            <div className="row">
                ...
                <div className="col-lg-4 col-md-6 col-sm12 text-center mb-5">
                    <h1 className='darkblue te'>Get in Touch</h1>
                    <div className="col-12">
                        <h1 className="yellow mb-5">ــــــــــــــــــــــــــــــــــــــــــ</h1>
                    </div>
                    ...
                    <div className='row'>
                        <div className="col-12 text-start">
                            ...
                            &nbsp;
                            <a href="https://wa.me/+201553576121" target="_blank" rel="noreferrer noopener">
                                <img src="/whatsapp.png" alt="WhatsApp" height={32} width={32} />
                            </a>
                        </div>
                    </div>
                </div>
                <div className="col-lg-4 col-md-6 col-sm12 text-cente mb-5">
                    <h1 className='darkblue'>Location</h1>
                    <div className="col-12">
                        <h1 className="yellow mb-5">ــــــــــــــــــــــــــــــــــــــــــ</h1>
                    </div>
