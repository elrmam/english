    ...
    <div className='container-fluid bg-black text-start pt-5'>
      <div className='row mx-2'>
        ...
        <div className='col-lg-1 col-md-6 col-sm-12 me-4'>
          ...
          <h6 className='mb-3'><Link className="footlink" style={{color:"#f2a74c"}} to="/#Services">About us</Link></h6>
          <h6 className='mb-3'><Link className="footlink" style={{color:"#f2a74c"}} to="/#About">Courses</Link></h6>
          <h6 className='mb-3'><Link className="footlink" style={{color:"#f2a74c"}} to="/#Goals">Events</Link></h6>
          <h6 className='mb-3'><Link className="footlink" style={{color:"#f2a74c"}} to="/#Projects">Team</Link></h6>
          <h6 className='mb-3'><Link className="footlink" style={{color:"#f2a74c"}} to="/#Licenses">Contact us</Link></h6>
        </div>
