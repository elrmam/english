  ...
  return (
    <div className='container-fluid bg-black text-start pt-5'>
      <div className='row mx-2'>
        <div className='col-lg-4 col-md-5 col-sm-12 ms-3 me-4 mb-5'>
        ...
        <div className='col-lg-1 col-md-6 col-sm-12 me-4 mb-5'>
        ...
        <div className='col-lg-3 col-md-5 col-sm-12 me-4 mb-5'>
